...
<aside>
    ...
    <nav>
        ...
        <div class="weather">
            ...
            <div class="location">
                <h5>Location:</h5>
                @if(!empty($weather['location']['city']))
                <span><strong>{{ $weather['location']['city'] }}</strong></span>
                @endif
            </div>

            <div class="ip">
                <h5>IP address:</h5>
                @if(!empty($weather['location']['ip']))
                <span><strong>{{ $weather['location']['ip'] }}</strong></span>
                @endif
            </div>
